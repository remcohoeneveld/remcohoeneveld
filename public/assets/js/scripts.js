...
$(document).ready(function () {
    ...
    $(function () {
        $(".custom-navbar a, #home a").bind("click", function (event) {
            var $anchor = $(this);
            $("html, body").stop().animate({scrollTop: $($anchor.attr("href")).offset().top - 20}, 1e3);
            event.preventDefault()
        })
    });
    ...
    $(".hire-me").on("click", function (e) {
        e.preventDefault();
        $("html, body").animate({scrollTop: $($(this).attr("href")).offset().top - 70}, 1500, "linear")
    });
...
var o = {
	...
	diagram: function(){
		...
		r.circle(300, 300, 85).attr({ stroke: 'none', fill: '#000000' });
...
window.onload = function() {
    ...
    var css = document.createElement("style");
    css.type = "text/css";
    css.innerHTML = ".typewrite > .wrap { border-right: 0.5em solid black}";
    document.body.appendChild(css);
};
var vid = "RpPYjePWPbs",
    streams,
